...
<header>
    ...
    <nav>
        <ul>
            ...
            <li><a href="/etudiants/ajouter">Étudiants</a></li>
    ...
    <section class="form-container">
        ...
        <form action="/notes/ajouter" method="post">
            ...
            <div class="form-group">
                ...
                <input type="number" name="noteObtenue" id="noteObtenue" placeholder="Note obtenue (0-20)" required min="0" max="20">
            </div>

            <div class="form-group">
                <label for="description">Description</label>
                <textarea name="description" id="description" placeholder="Description (optionnel)"></textarea>
            </div>

            <div class="form-group">
                <label for="evenement">Événement</label>
                <input type="text" name="evenement" id="evenement" placeholder="Examen, contrôle... (optionnel)">
            </div>

            <div class="form-buttons">
                <button type="submit" class="btn btn-primary">Ajouter</button>
                <a href="/notes/lister" class="btn btn-primary">Annuler</a>
            </div>
        </form>
    </section>
</main>
